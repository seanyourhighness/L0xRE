...
| [**L0xRE-BeeLLama-Low**](https://github.com/seanyourhighness/L0xRE-BeeLLama-Low) · Windows | Precompiled Windows runtimes, one zip per GPU arch (SM120 / SM89 / SM86) | GGUF | Binary-verified (arch cubins, PE exports, SHA256SUMS); **not yet executed on target hardware** — SM86 zip is experimental | Release `beellama-v0.4.7-windows-r1` | [Release](https://github.com/seanyourhighness/L0xRE-BeeLLama-Low/releases/tag/beellama-v0.4.7-windows-r1) |
