...
| **L0xRE-BeeLLama-Low** · SM89 | Same runtime on RTX 4090-class GPUs | GGUF | RTX 4090 (SM89) — sprint-RC profile qualified; package pending | Unqualified package pending | — |
| [**L0xRE-27b-Low**](https://huggingface.co/YourHighnessLA/L0xRE-27b-Low) | Smaller-footprint 27B MoE (formerly Escha E3) with measured native-GGUF parity | GGUF (requires L0xRE-BeeLLama-Low; **not** stock llama.cpp/Ollama/LM Studio) | Served via L0xRE-BeeLLama-Low SM120 (qualified) / SM89 (sprint-RC) | Not yet published | — |
...
- EXL3 offload (5090: 64.04 tok/s; 4090: 26.53 tok/s static+MTP3): `benchmarks/` in the
  offload repo.
- N/150 quality results: pending — will be published with the L0xRE-27b-Low model card.
  No quality-equivalence claim is made before those receipts exist.
